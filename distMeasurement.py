...
def create_packet(id):
    """Create a new packet based on the given 'id.' """
...
def do_one(dest_addr, timeout=1):
    ...
    while packet:
        ...
        """TODO I think I need to find a way to send this to a port that doesn't exist,
        meaning I have to find a way to specify the port number here"""
        sent = my_socket.sendto(packet, (dest_addr, 1))
        packet = packet[sent:]
    delay = receive_response(my_socket, packet_id, time.time(), timeout)
    #TODO save the number of hops
    #TODO put the number of hops and RTT into a good format
    my_socket.close()
    #TODO return the number of hops and the RTT
    return delay


def receive_response(my_socket, packet_id, time_sent, timeout):
    # Receive the ping from the socket.
    #TODO get the RTT and number of hops from the return ping
    time_left = timeout
    while True:
...
#TODO figure out if you need this class
...
#TODO please dear god change this
